        ...
        <nav className='container1'>
            <div className="nav">
                <div className='nav_panel1'>
                    ...
                    <input type="text" className='nav_panel1_input' placeholder='__azaza__' />
                    <button className="nav_button open__aside"><img src={collab} alt="search" className='nav_panel1_icon' /></button>
