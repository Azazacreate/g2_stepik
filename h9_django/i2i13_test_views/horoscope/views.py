...
def get__converter_date(request, sign_zodiac):
...
class Person:
    ...
    age: int
    def __str__(self):
        return f'This is {self.name}. Age is {self.age}'
...
def get__sign_zodiac(request, sign_zodiac: str):
    ...
    data = {
        ...
        'float_1': 2.2,
        'list_1': [1, 2, 3],
        'tuple_1': (1, 'string_1', 3, 4.5),
        'dict_1': {'key': 'value', 'name': 'Jack', 'age': 40},
        'class_1': Person('Will', 15),
    }
